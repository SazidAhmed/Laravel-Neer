                ...
                <div class="table-responsive">
                  <table id="example" class="table table-sm table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Payment</td>
                        <td><input type="checkbox" name="permissions[payment][can-add]" @if(isset($role['permissions']['payment']['can-add']))checked @endif value="1"></td>
                        <td><input type="checkbox" name="permissions[payment][can-edit]" @if(isset($role['permissions']['payment']['can-edit']))checked @endif value="1"></td>
                        <td><input type="checkbox" name="permissions[payment][can-delete]" @if(isset($role['permissions']['payment']['can-delete']))checked @endif value="1"></td>
                        <td><input type="checkbox" name="permissions[payment][can-view]" @if(isset($role['permissions']['payment']['can-view']))checked @endif value="1"></td>
                        <td><input type="checkbox" name="permissions[payment][can-list]" @if(isset($role['permissions']['payment']['can-list']))checked @endif value="1"></td>
                      </tr>
                      <tr>
                        <td>Notice</td>
                ...
                <div class="table-responsive">
                  <table id="example" class="table table-sm table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Payment</td>
                        <td><input type="checkbox" name="permissions[payment][can-add]" value="1"></td>
                        <td><input type="checkbox" name="permissions[payment][can-edit]" value="1"></td>
                        <td><input type="checkbox" name="permissions[payment][can-delete]" value="1"></td>
                        <td><input type="checkbox" name="permissions[payment][can-view]" value="1"></td>
                        <td><input type="checkbox" name="permissions[payment][can-list]" value="1"></td>
                      </tr>
                      <tr>
                        <td>Notice</td>
